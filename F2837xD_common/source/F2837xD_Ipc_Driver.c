//###########################################################################
// FILE:   F2837x_Ipc_Driver.c
// TITLE:  F2837x Inter-Processor Communication (IPC) API Driver Functions.
// DESCRIPTION:
...
//! seconadry CPU system
//!
//! \param psMessage specifies the pointer to the message received from the 
//! seconadry CPU system which includes the 16/32-bit data word to write to the 
//! local CPU address.
//!
//! This function will allow the local CPU system to write a 16/32-bit word
//! received from the seconadry CPU system to the write-protected address indicated
//! in \e *psMessage.
