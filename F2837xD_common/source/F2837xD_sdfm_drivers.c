...
Uint16 Sdfm_readManchesterStatus(Uint16 sdfmNumber, Uint16 filterNumber)
{
	...
	switch(filterNumber){
		...
		case FILTER1:
			modulatorStatus = (*SDFM[sdfmNumber]).SDCTLPARM1.bit.MS;
			break;
		case FILTER2:
			modulatorStatus = (*SDFM[sdfmNumber]).SDCTLPARM2.bit.MS;
			break;
		case FILTER3:
			modulatorStatus = (*SDFM[sdfmNumber]).SDCTLPARM3.bit.MS;
			break;
		case FILTER4:
			modulatorStatus = (*SDFM[sdfmNumber]).SDCTLPARM4.bit.MS;
			break;
	}
