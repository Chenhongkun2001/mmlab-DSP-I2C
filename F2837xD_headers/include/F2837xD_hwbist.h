/******************************************************************************
*
* Register Bit Structured header file for HWBIST
*
...
******************************************************************************
*/
#ifndef __F2837xD_HWBIST_H__
#define __F2837xD_HWBIST_H__
...
struct CSTCSEM_BITS {                   // bits description
    Uint16 SEMAPHORE:2;                 // 1:0 Semaphore
    Uint16 rsvd1:14;                    // 15:2 Reserved
    Uint16 rsvd2:16;                    // 31:16 Reserved
};
